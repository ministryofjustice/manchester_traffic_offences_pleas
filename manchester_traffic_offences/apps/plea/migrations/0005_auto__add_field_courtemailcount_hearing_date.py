...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourtEmailCount.hearing_date'
        db.add_column(u'plea_courtemailcount', 'hearing_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 15, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourtEmailCount.hearing_date'
        db.delete_column(u'plea_courtemailcount', 'hearing_date')
