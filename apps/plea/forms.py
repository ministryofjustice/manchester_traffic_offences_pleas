...
class CaseForm(BasePleaStepForm):
    ...
    number_of_charges = forms.IntegerField(label=_("Number of charges against you"),
                                           widget=forms.TextInput(attrs={"pattern": "[0-9]+", "type": "number", "class": "form-control-inline"}),
...
class CompanyFinancesForm(BasePleaStepForm):
    ...
    gross_turnover = forms.DecimalField(widget=forms.TextInput(attrs={"type": "number",
                                                                      "pattern": "[0-9]+",
                                                                      "min": "0",
                                                                      "max": "9999999999",
                                                                      "class": "form-control-inline"}),
    ...
    net_turnover = forms.DecimalField(widget=forms.TextInput(attrs={"type": "number",
                                                                    "pattern": "[0-9]+",
                                                                    "min": "0",
                                                                    "max": "9999999999",
                                                                    "class": "form-control-inline"}),
