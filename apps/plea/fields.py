...
ERROR_MESSAGES = {
    ...
    "CORRECT_ADDRESS_REQUIRED": _("Tell us if your address on the notice is correct "),
    "UPDATED_ADDRESS_REQUIRED": _("Tell us your address"),
    "COMPANY_CORRECT_ADDRESS_REQUIRED": _("Tell us if the company's address on the notice is correct"),
