...
ERROR_MESSAGES = {
    ...
    "EMPLOYMENT_STATUS_REQUIRED": _("Select your employment status"),
    "PAY_PERIOD_REQUIRED": _("Tell us how often you get paid"),
    "PAY_AMOUNT_REQUIRED": _("Enter your take home pay"),
    "BENEFIT_TYPE_REQUIRED": _("Select the out of work benefit you receive"),
    "BENEFIT_PAY_PERIOD_REQUIRED": _("Select how often your benefit is paid"),
    "BENEFIT_PAY_AMOUNT_REQUIRED": _("Enter the amount of your benefit payment"),
    "INCOME_SOURCE_REQUIRED": _("Tell us the source of your main income"),
    ...
    "OTHER_NOT_LISTED_REQUIRED": _("Tell us if you have any other significant expenses"),
    "OTHER_NOT_LISTED_DETAILS_REQUIRED": _("Enter your other significant expenses"),
    "OTHER_NOT_LISTED_AMOUNT_REQUIRED": _("Enter the monthly total of your other significant expenses"),
    "OTHER_NOT_LISTED_AMOUNT_INVALID": _("The monthly total must be a number"),
    "OTHER_NOT_LISTED_AMOUNT_MIN": _("The monthly total must be a number greater than, or equal to, 0"),
