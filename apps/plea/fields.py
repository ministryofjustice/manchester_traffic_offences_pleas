...
class HearingDateWidget(MultiWidget):
    def __init__(self, attrs=None):
        widgets = [DSDateTemplateWidget(attrs={"pattern": "[0-9]+", "type": "number", "class": "form-control-day"}, context={"title": "Day"}),
                   DSDateTemplateWidget(attrs={"pattern": "[0-9]+", "type": "number", "class": "form-control-month"}, context={"title": "Month"}),
                   DSDateTemplateWidget(attrs={"pattern": "[0-9]+", "type": "number", "class": "form-control-year"}, context={"title": "Year"}),
                   ]
...
class URNWidget(MultiWidget):
    def __init__(self, attrs=None):
        widgets = [DSURNTemplateWidget(attrs={"pattern": "[0-9]+", "type": "number", "class": "form-control-urn-2"}, context={"title": "Part 1"}),
                   DSURNTemplateWidget(attrs={"pattern": "[A-Z]+", "class": "form-control-urn-2"}, context={"title": "Part 2"}),
                   DSURNTemplateWidget(attrs={"pattern": "[0-9]+", "type": "number", "class": "form-control-urn-7"}, context={"title": "Part 3"}),
                   DSURNTemplateWidget(attrs={"pattern": "[0-9]+", "type": "number", "class": "form-control-urn-2"}, context={"title": "Part 4"}),
                   ]
