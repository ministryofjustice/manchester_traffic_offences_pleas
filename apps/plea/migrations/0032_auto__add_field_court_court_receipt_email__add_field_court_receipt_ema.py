...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Court.court_receipt_email'
        db.add_column(u'plea_court', 'court_receipt_email',
    ...
    def backwards(self, orm):
        # Deleting field 'Court.court_receipt_email'
        db.delete_column(u'plea_court', 'court_receipt_email')
    ...
    models = {
        ...
        u'plea.court': {
            ...
            'receipt_email': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
