    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forenames', models.CharField(help_text=b'as supplied by DX', max_length=105, null=True, blank=True)),
                ('surname', models.CharField(help_text=b'as supplied by DX', max_length=35, null=True, blank=True)),
                ('case_number', models.CharField(help_text=b'as supplied by DX', max_length=10, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region_code', models.CharField(help_text=b'The initial two digit URN number, e.g. 06', unique=True, max_length=2)),
                ('court_name', models.CharField(max_length=255)),
                ('court_address', models.TextField()),
                ('court_telephone', models.CharField(max_length=50)),
                ('court_email', models.CharField(help_text=b'A user facing email address', max_length=255)),
                ('submission_email', models.CharField(help_text=b'The outbound court email used to send submission data', max_length=255)),
                ('court_receipt_email', models.CharField(help_text=b'The email address the court uses to send receipt emails to MaP', max_length=255, null=True, blank=True)),
                ('local_receipt_email', models.CharField(help_text=b'The inbound receipt email address. Used for validation purposes.', max_length=255, null=True, blank=True)),
                ...
                ('test_mode', models.BooleanField(default=False, help_text=b'Is this court entry used for testing purposes?')),
            ],
            options={
            },
            bases=(models.Model,),
