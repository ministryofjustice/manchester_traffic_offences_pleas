...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UsageStats.start_date'
        db.alter_column(u'plea_usagestats', 'start_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'UsageStats.start_date'
        db.alter_column(u'plea_usagestats', 'start_date', self.gf('django.db.models.fields.DateTimeField')())
