...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CourtEmailCount.status'
        db.alter_column(u'plea_courtemailcount', 'status', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # Changing field 'CourtEmailCount.status'
        db.alter_column(u'plea_courtemailcount', 'status', self.gf('django.db.models.fields.CharField')(max_length=30))
