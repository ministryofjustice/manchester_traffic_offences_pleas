    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_data_hash', models.CharField(default=b'', help_text=b'If the event caused a change to the extra_data then store the hash of it for debugging', max_length=32, verbose_name=b'extra data hash')),
