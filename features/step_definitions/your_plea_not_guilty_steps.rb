When(/^I select not guilty to one charge$/) do
  common_page.id_guilty_not_guilty.click
end
...
When(/^I successfully fill out the not guilty form$/) do
  ...
  your_plea_not_guilty_page.block_label[5].id_interpreter_needed_true.click
  language_group = your_plea_not_guilty_page.section_interpreter_language
  language_group.id_interpreter_language.set 'German'
  your_plea_not_guilty_page.block_label[7].id_disagree_with_evidence_true.click
  ...
  your_plea_not_guilty_page.block_label[9].id_witness_needed_true.click
  ...
  your_plea_not_guilty_page.block_label[11].id_witness_interpreter_needed_true.click
...
And(/^it should display yes and no option an interpreter in court$/) do
  expect(your_plea_not_guilty_page.block_label[5].text).to eq 'Yes'
  expect(your_plea_not_guilty_page.block_label[5].id_interpreter_needed_true['type']).to eq 'radio'
  expect(your_plea_not_guilty_page.block_label[6].text).to eq 'No'
  expect(your_plea_not_guilty_page.block_label[6].id_interpreter_needed_false['type']).to eq 'radio'
end
...
And(/^it should display yes and no option for disagree with any evidence$/) do
  expect(your_plea_not_guilty_page.block_label[7].text).to eq 'Yes'
  expect(your_plea_not_guilty_page.block_label[7].id_disagree_with_evidence_true['type']).to eq 'radio'
  expect(your_plea_not_guilty_page.block_label[8].text).to eq 'No'
  expect(your_plea_not_guilty_page.block_label[8].id_disagree_with_evidence_false['type']).to eq 'radio'
end
